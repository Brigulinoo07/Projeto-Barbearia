    ...
    <main>
      <div class="container">
        ...
        <div class="divSalao">
          <div class="row">
            <div class="col">
              <img src="images/salao.jpg" class="figure-img img-fluid rounded"  alt="..."> 
            </div>
            <div class="col">
              <div class="txtHome">
                <h2 class="h2Home"><span class="">STYLE BARBER POINT</span></h2>
                <p class="lead">
                    Estamos localizados na Etec Zona Leste, próximo ao Terminal A.E Carvalho, privilegiada pelo comércio e 
                    crescimento da verticalização empresarial. Oferecemos os mais sofisticados cortes de cabelo e barba, 
                    desde cortes clássicos, aqueles que marcaram época e fazem sucesso até os dias de hoje e também 
                    modernos e infantis. Contamos com uma equipe com barbeiros altamentes experientes na área aguardando 
                    para atendê-los!
                </p>
              </div>
            </div>

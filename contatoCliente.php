...
<html lang="pt-br">
  <head>
    ...
    <title>Contato - Style Barber Point</title>
      ...
      <div class="container">    
        ...
        <div class="container">
          <div class="row">
            <div class="col">
              <div class="container">
                <div class="divContato">
                  <h1 class="h1Contato">Contate-nos</h1>
                  <p class="pContato">Nosso endereço de correspondencia é: Av. Águia de Haia, 2633 - Cidade Antônio Estêvão de Carvalho,</p>
                  <p class="pContato">São Paulo - SP, 03694-000</p>
                  <p class="pContato">Telefone: (11) 0000-0000</p>
                  <ul class="ulContato">
                    <li>
                      <a href="https://www.facebook.com/" target="_blank">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" class="bi bi-facebook" viewBox="0 0 16 16">
            ...
            <div class="col">
              <div class="divForm">
                <form method="post" action="controller/ControllerContato.php?funcao=contato" class="needs-validation" novalidate="" id="form" name="form"> 
                  <p class="pForm">Preencha os dados abaixo.</p>         

                  <div class="mb-3">
                    <label for="txtNomeCtt" class="form-label">Nome</label>
                    <input type="text" class="form-control" id="txtNomeCtt" name="txtNomeCtt" size="40" maxlength="40" placeholder="Insira seu nome completo" required="">
                  ...
                  <div class="mb-3">   
                    <label for="txtEmailCtt" class="form-label">Email</label>
                    <input type="email" class="form-control" id="txtEmailCtt" name="txtEmailCtt" placeholder="Insira o seu email (ex: nome@exemplo.com)" required="">            
                    <div class="invalid-feedback">
                  ...
                  <div class="mb-3">      
                    <label for="cboTipoMSG" class="form-label">Assunto</label>
                    <select class="form-select" id="cboTipoMSG" name="cboTipoMSG" required="">
                      <option selected="" disabled="" value="">Escolha uma opção...</option>
                      <option>Feedback</option>
                      <option>Parceria/Anunciar</option>
                    ...
                    <div class="invalid-feedback">
                      ...
                      <!--Campo para inserir a mensagem que deseja enviar-->
                  <div class="mb-3">   
                    <label for="txtMsgCtt" class="form-label">Mensagem</label>
                    <textarea class="form-control" id="txtMsgCtt" name="txtMsgCtt" maxlength="300" rows="3" required="" placeholder="Escreva a mensagem que deseja enviar (max: 300 caracteres)"></textarea>   
                    <div class="invalid-feedback">
                      Insira a mensagem que você deseja enviar.    
                    </div>     
                  </div>    
                        ...
                        .forEach(function (form) 
                        {
                          ...
                          form.addEventListener('submit', function (event) 
                          {
                              ...
                              if (!form.checkValidity()) 
                              {
                                ...
                                alert("Erro!!! Contém campos não preenchidos/preencha da maneira correta.");
                              }
